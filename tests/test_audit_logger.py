...
class TestAuditLogger:
    ...
    def logger(self, test_data_dir):
        ...
        return AuditLogger(log_file="test_audit.log", log_dir=str(test_data_dir))

    def test_log_action(self, logger):
        """Test logging user action"""
        logger.log_action(
            user_id="user_123", action="code_review", resource="/repo/file.py", result="success"
        )
    ...
    def test_log_security_event(self, logger):
        ...
        logger.log_security_event(
            event_type="unauthorized_access", severity="high", details={"ip": "192.168.1.1"}
        )
    ...
    def test_log_compliance_check(self, logger):
        ...
        logger.log_compliance_check(standard="SOC2", result="FAILED", violations=violations)
